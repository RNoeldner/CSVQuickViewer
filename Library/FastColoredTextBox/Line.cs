...
namespace FastColoredTextBoxNS
{
  ...
  public class Line : IList<Char>
  {
    ...
    System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() => chars.GetEnumerator() as System.Collections.IEnumerator;
    ...
    public virtual void TrimExcess() => chars.TrimExcess();

    public virtual void AddRange(IEnumerable<Char> collection) => chars.AddRange(collection);
  }
  ...
  public struct LineInfo
  {
    ...
    internal int GetWordWrapStringStartPosition(int iWordWrapLine) => iWordWrapLine == 0 ? 0 : CutOffPositions[iWordWrapLine - 1];
