...
namespace FastColoredTextBoxNS
{
  public class CommandManager
  {
    ...
    private void EndDisableCommands() => disabledCommands--;

    private void BeginDisableCommands() => disabledCommands++;
    ...
    public void BeginAutoUndoCommands() => autoUndoCommands++;
  ...
  public abstract class UndoableCommand : Command
  {
    ...
    public virtual void Undo() => OnTextChanged(true);
