...
namespace FastColoredTextBoxNS
{
  ...
  public class Range : IEnumerable<Place>
  {
    ...
    /// </summary>
    public string GetCharsAfterStart(int charsCount) => GetCharsBeforeStart(-charsCount);

    /// <summary>
    /// Clone range
    /// </summary>
    /// <returns></returns>
    public Range Clone() => (Range)MemberwiseClone();
    ...
    public void SetFoldingMarkers(string startFoldingPattern, string finishFoldingPattern) => SetFoldingMarkers(startFoldingPattern, finishFoldingPattern, SyntaxHighlighter.RegexCompiledOption);
    ...
    public IEnumerable<Range> GetRanges(string regexPattern) => GetRanges(regexPattern, RegexOptions.None);
    ...
    System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() => (this as IEnumerable<Place>).GetEnumerator();
    ...
    public Range GetFragment(string allowedSymbolsPattern) => GetFragment(allowedSymbolsPattern, RegexOptions.None);
    ...
    private bool IsSpaceChar(char c) => c == ' ' || c == '\t';
    ...
    internal void GoRight_ColumnSelectionMode() => End = new Place(End.iChar + 1, End.iLine);
