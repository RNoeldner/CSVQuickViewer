...
namespace FastColoredTextBoxNS
{
  ...
  public class Bookmarks : BaseBookmarks
  {
    ...
    public override void Add(int lineIndex, string bookmarkName) => Add(new Bookmark(tb, bookmarkName ?? "Bookmark " + counter, lineIndex));

    public override void Add(int lineIndex) => Add(new Bookmark(tb, "Bookmark " + counter, lineIndex));
    ...
    /// </summary>
    public override Bookmark GetBookmark(int i) => items[i];
  }
