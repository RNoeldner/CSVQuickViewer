...
namespace CsvTools
{
  ...
  public sealed class CsvFileReader : BaseFileReader, IFileReader
  {
    ...
    */
      ...
      Restart:
        ...
        else
        {
          ...
          else
          {
            ...
            while (item != null)
            {
              // If a column is quoted and does contain the delimiter and linefeed, issue a warning,
              // we might have an opening delimiter with a missing closing delimiter
              if (EndLineNumber > StartLineNumber + 4 && item.Length > 1024
    ...
    private string ReadNextColumnEnd(
      int columnNo,
      StringBuilder stringBuilder,
      bool storeWarnings,
      bool quoted,
      bool hadUnknownChar,
      bool hadDelimiterInValue,
      bool hadNbsp)
    {
