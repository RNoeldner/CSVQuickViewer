...
namespace CsvTools
{
  ...
  {
    public ImmutableFileFormat(bool isFixedLength, bool qualifyAlways, bool qualifyOnlyIfNeeded, [NotNull] string newLinePlaceholder, [NotNull] string delimiterPlaceholder, char fieldDelimiterChar, char fieldQualifierChar, [NotNull] string quotePlaceholder)
    {
    ...
    public ImmutableFileFormat([NotNull] IFileFormat other) : this(other.IsFixedLength, other.QualifyAlways,
      ...
      other.FieldQualifierChar, other.QuotePlaceholder)
    {
    }
