  ...
  public class ImprovedStream : Stream, IImprovedStream
  {
    ...
    private void OpenZipOverBase()
    {
      ...
      else
      {
        ...
        // Check the stream if it alraedfy contains the file; if so remove the old file
        ...
        if (copyOtherFiles)
        {
          ...
          try
          {
            ...
            // build a new Zipfile with the contens of the old one but exlode the file we are about
            // to write
