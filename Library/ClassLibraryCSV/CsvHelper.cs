    ...
    FillGuessSettings fillGuessSettings, bool detectFormat, string pgpKey, IProgressWithCancellation progress)
  {
    ...
    do
    {
      ...
      if (!inspectionResult.IsJson && !inspectionResult.IsXml)
      {
        ...
        using var reader = inspectionResult.GetFileReader(usedStream);
  ...
  private static IFileReader GetFileReader(this InspectionResult inspectionResult, in Stream? stream)
  {
    if (stream is MemoryStream memStream)
    {
      ...
      return new CsvFileReader(memStream, codePageId: inspectionResult.CodePageId,
                               ...
                               escapeCharacterChar: inspectionResult.EscapePrefix, recordLimit: 0L,
                               ...
                               newLinePlaceholder: string.Empty, delimiterPlaceholder: string.Empty,
