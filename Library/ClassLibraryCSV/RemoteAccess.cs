...
#pragma warning restore CS0659
  {
    ...
    public override int GetHashCode()
    {
      unchecked
      {
        ...
        hashCode = (hashCode * 397) ^ (m_EncryptedHostName != null
                                         ? StringComparer.OrdinalIgnoreCase.GetHashCode(m_EncryptedHostName)
                                         : 0);
        hashCode = (hashCode * 397)
                   ^ (EncryptedUser != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(EncryptedUser) : 0);
        return hashCode;
      }
    }
