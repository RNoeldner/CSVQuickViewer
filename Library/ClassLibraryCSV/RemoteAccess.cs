...
#pragma warning restore CS0659 // Type overrides Object.Equals(object o) but does not override Object.GetHashCode()
  {
    ...
    public void CopyTo(RemoteAccess other)
    {
      if (other == null)
        return;
      other.Password = m_EncryptedPassword;
      other.User = m_User;
    ...
    public bool Equals(RemoteAccess other)
    {
      ...
      return string.Equals(m_EncryptedPassword, other.m_EncryptedPassword) && m_Protocol == other.m_Protocol &&
             string.Equals(m_HostName, other.m_HostName, StringComparison.OrdinalIgnoreCase) &&
             string.Equals(m_User, other.m_User, StringComparison.OrdinalIgnoreCase);
    }
