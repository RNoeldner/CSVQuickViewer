...
namespace CsvTools.Tests
{
  ...
  {
    private readonly PGPKeyStorage m_PGPKeyStorage = new PGPKeyStorage();

    [TestInitialize]
    public void Init()
    {
      m_PGPKeyStorage.EncryptedPassphase = "UGotMe".Encrypt();
      m_PGPKeyStorage.AddPrivateKey(PRIVATE);
      m_PGPKeyStorage.AddPublicKey(PUBLIC);
    }
