namespace CsvTools
{
  partial class FillGuessSettingEdit
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.trackBarCheckedRecords.DataBindings.Add(new System.Windows.Forms.Binding("Value",
        this.fillGuessSettingsBindingSource, "CheckedRecords", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      this.trackBarCheckedRecords.DataBindings.Add(new System.Windows.Forms.Binding("Enabled",
        this.fillGuessSettingsBindingSource, "Enabled", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      ...
      this.textBoxCheckedRecords.DataBindings.Add(new System.Windows.Forms.Binding("Text",
        this.fillGuessSettingsBindingSource, "CheckedRecords", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      this.textBoxCheckedRecords.DataBindings.Add(new System.Windows.Forms.Binding("Enabled",
        this.fillGuessSettingsBindingSource, "Enabled", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      this.textBoxCheckedRecords.Location = new System.Drawing.Point(213, 68);
      ...
      this.textBoxCheckedRecords.Size = new System.Drawing.Size(63, 22);
      this.textBoxCheckedRecords.TabIndex = 4;
      this.toolTip.SetToolTip(this.textBoxCheckedRecords,
        "The more records are read the higher is the chance to get a good variety of sampl" +
        "e values, especially for sparsely populated columns");
      // 
      // textBoxSampleValues
      // 
      this.textBoxSampleValues.DataBindings.Add(
        new System.Windows.Forms.Binding("Text", this.fillGuessSettingsBindingSource, "SampleValues", true));
      this.textBoxSampleValues.DataBindings.Add(new System.Windows.Forms.Binding("Enabled",
        this.fillGuessSettingsBindingSource, "Enabled", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      this.textBoxSampleValues.Location = new System.Drawing.Point(213, 27);
      ...
      this.textBoxSampleValues.Size = new System.Drawing.Size(63, 22);
      this.textBoxSampleValues.TabIndex = 1;
      this.toolTip.SetToolTip(this.textBoxSampleValues,
        "As the amount of sample is found the detection process will start");
      this.textBoxSampleValues.Validating +=
        new System.ComponentModel.CancelEventHandler(this.TextBoxSampleValues_Validating);
      // 
      ...
      this.checkBoxDectectNumbers.DataBindings.Add(new System.Windows.Forms.Binding("Enabled",
        this.fillGuessSettingsBindingSource, "Enabled", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      this.checkBoxDectectNumbers.DataBindings.Add(new System.Windows.Forms.Binding("Checked",
        this.fillGuessSettingsBindingSource, "DectectNumbers", true));
      this.checkBoxDectectNumbers.Location = new System.Drawing.Point(3, 97);
      ...
      this.toolTip.SetToolTip(this.checkBoxDectectNumbers,
        "Numbers with leading 0 will not be regarded as numbers to prevent information los" + "s");
      this.checkBoxDectectNumbers.UseVisualStyleBackColor = true;
      // 
      // label21
      // 
      this.label21.AutoSize = true;
      this.label21.Location = new System.Drawing.Point(282, 247);
      this.label21.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
      this.label21.Name = "label21";
      this.label21.Size = new System.Drawing.Size(641, 17);
      ...
      this.checkBoxDectectPercentage.DataBindings.Add(new System.Windows.Forms.Binding("Checked",
        this.fillGuessSettingsBindingSource, "DectectPercentage", true));
      this.checkBoxDectectPercentage.DataBindings.Add(new System.Windows.Forms.Binding("Enabled",
        this.fillGuessSettingsBindingSource, "Enabled", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      this.checkBoxDectectPercentage.Location = new System.Drawing.Point(3, 222);
      ...
      this.checkBoxDetectDateTime.DataBindings.Add(new System.Windows.Forms.Binding("Checked",
        this.fillGuessSettingsBindingSource, "DetectDateTime", true));
      this.checkBoxDetectDateTime.DataBindings.Add(new System.Windows.Forms.Binding("Enabled",
        this.fillGuessSettingsBindingSource, "Enabled", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      ...
      this.toolTip.SetToolTip(this.checkBoxDetectDateTime,
        "Detect dates and times on a variety of formats, to make sure the order of day and" +
      ...
      this.label23.Location = new System.Drawing.Point(282, 122);
      ...
      this.label30.Location = new System.Drawing.Point(282, 222);
      ...
      this.checkBoxDetectBoolean.DataBindings.Add(new System.Windows.Forms.Binding("Checked",
        this.fillGuessSettingsBindingSource, "DetectBoolean", true));
      this.checkBoxDetectBoolean.DataBindings.Add(new System.Windows.Forms.Binding("Enabled",
        this.fillGuessSettingsBindingSource, "Enabled", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      this.checkBoxDetectBoolean.Location = new System.Drawing.Point(3, 247);
      ...
      this.toolTip.SetToolTip(this.checkBoxDetectBoolean,
        "Detect Boolean values, the minimum number of samples does not need to be checked " + "to allow detection");
      this.checkBoxDetectBoolean.UseVisualStyleBackColor = true;
      // 
      // textBoxTrue
      // 
      this.textBoxTrue.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.fillGuessSettingsBindingSource,
        "TrueValue", true));
      this.textBoxTrue.DataBindings.Add(new System.Windows.Forms.Binding("Enabled", this.fillGuessSettingsBindingSource,
        "Enabled", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      this.textBoxTrue.Location = new System.Drawing.Point(91, 247);
      this.textBoxTrue.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
      this.textBoxTrue.Name = "textBoxTrue";
      this.textBoxTrue.Size = new System.Drawing.Size(63, 22);
      ...
      // textBoxFalse
      // 
      this.textBoxFalse.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.fillGuessSettingsBindingSource,
        "FalseValue", true));
      this.textBoxFalse.DataBindings.Add(new System.Windows.Forms.Binding("Enabled",
        this.fillGuessSettingsBindingSource, "Enabled", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      this.textBoxFalse.Location = new System.Drawing.Point(213, 247);
      this.textBoxFalse.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
      this.textBoxFalse.Name = "textBoxFalse";
      this.textBoxFalse.Size = new System.Drawing.Size(63, 22);
      ...
      this.checkBoxSerialDateTime.DataBindings.Add(new System.Windows.Forms.Binding("Checked",
        this.fillGuessSettingsBindingSource, "SerialDateTime", true));
      this.checkBoxSerialDateTime.DataBindings.Add(new System.Windows.Forms.Binding("Enabled",
        this.fillGuessSettingsBindingSource, "Enabled", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      this.checkBoxSerialDateTime.Location = new System.Drawing.Point(3, 172);
      ...
      this.toolTip.SetToolTip(this.checkBoxSerialDateTime,
        "Excel stores dates as number of days after the December 31, 1899: \r\nJanuary 1, 19" +
      ...
      this.label32.Location = new System.Drawing.Point(282, 172);
      ...
      this.checkBoxDetectGUID.DataBindings.Add(
        new System.Windows.Forms.Binding("Checked", this.fillGuessSettingsBindingSource, "DetectGUID", true));
      this.checkBoxDetectGUID.DataBindings.Add(new System.Windows.Forms.Binding("Enabled",
        this.fillGuessSettingsBindingSource, "Enabled", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      this.checkBoxDetectGUID.Location = new System.Drawing.Point(3, 273);
      ...
      this.toolTip.SetToolTip(this.checkBoxDetectGUID,
        "Detect Globally Unique Identifiers sometimes named UUID or universally unique ide" + "ntifier");
      ...
      this.checkBox1.DataBindings.Add(new System.Windows.Forms.Binding("Checked", this.fillGuessSettingsBindingSource,
        "IgnoreIdColums", true));
      this.checkBox1.DataBindings.Add(new System.Windows.Forms.Binding("Enabled", this.fillGuessSettingsBindingSource,
        "Enabled", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      ...
      this.label1.Location = new System.Drawing.Point(282, 298);
      ...
      this.label19.Location = new System.Drawing.Point(282, 70);
      ...
      this.label20.Location = new System.Drawing.Point(282, 27);
      ...
      // textBoxMinSamples
      // 
      this.textBoxMinSamples.DataBindings.Add(
        new System.Windows.Forms.Binding("Text", this.fillGuessSettingsBindingSource, "MinSamples", true));
      this.textBoxMinSamples.DataBindings.Add(new System.Windows.Forms.Binding("Enabled",
        this.fillGuessSettingsBindingSource, "Enabled", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      ...
      this.textBoxMinSamples.Size = new System.Drawing.Size(63, 22);
      this.textBoxMinSamples.TabIndex = 9;
      this.toolTip.SetToolTip(this.textBoxMinSamples,
        "A higher the number of samples ensures the guessed format is correct, columns tha" +
        "t not contain a variety of values might not provide may samples\r\n");
      this.textBoxMinSamples.Validating +=
        new System.ComponentModel.CancelEventHandler(this.TextBoxMinSamples_Validating);
      // 
      // checkBoxNamedDates
      // 
      this.checkBoxNamedDates.AutoSize = true;
      this.tableLayoutPanel1.SetColumnSpan(this.checkBoxNamedDates, 3);
      this.checkBoxNamedDates.DataBindings.Add(new System.Windows.Forms.Binding("Checked",
        this.fillGuessSettingsBindingSource, "CheckNamedDates", true));
      this.checkBoxNamedDates.DataBindings.Add(new System.Windows.Forms.Binding("Enabled",
        this.fillGuessSettingsBindingSource, "Enabled", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      this.checkBoxNamedDates.Location = new System.Drawing.Point(3, 147);
      ...
      this.toolTip.SetToolTip(this.checkBoxNamedDates,
        "Detect dates with names days or month, e.G. Monday, 3. May 2017");
      ...
      this.checkBoxDateParts.DataBindings.Add(
        new System.Windows.Forms.Binding("Checked", this.fillGuessSettingsBindingSource, "DateParts", true));
      this.checkBoxDateParts.DataBindings.Add(new System.Windows.Forms.Binding("Enabled",
        this.fillGuessSettingsBindingSource, "Enabled", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      this.checkBoxDateParts.Location = new System.Drawing.Point(3, 197);
      ...
      this.toolTip.SetToolTip(this.checkBoxDateParts,
        "Find columns that possible correspond to a date colum to combine date and time");
      ...
      this.label5.Location = new System.Drawing.Point(282, 197);
      this.label5.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
      this.label5.Name = "label5";
      this.label5.Size = new System.Drawing.Size(652, 17);
      ...
      this.tableLayoutPanel1.RowStyles.Add(new System.Windows.Forms.RowStyle());
      this.tableLayoutPanel1.RowStyles.Add(new System.Windows.Forms.RowStyle());
      this.tableLayoutPanel1.Size = new System.Drawing.Size(947, 321);
      ...
      this.radioButtonEnabled.DataBindings.Add(new System.Windows.Forms.Binding("Checked",
        this.fillGuessSettingsBindingSource, "Enabled", true,
        System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      ...
      this.Font = new System.Drawing.Font("Microsoft Sans Serif", 7.8F, System.Drawing.FontStyle.Regular,
        System.Drawing.GraphicsUnit.Point, ((byte) (0)));
      this.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
      this.MinimumSize = new System.Drawing.Size(947, 370);
      this.Name = "FillGuessSettingEdit";
      this.Size = new System.Drawing.Size(947, 370);
