...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    private void InitializeComponent()
    {
      ...
      this.m_RadioButtonNeeded.DataBindings.Add(new System.Windows.Forms.Binding("Checked",
      ...
      this.m_RadioButtonAlways.DataBindings.Add(
        new System.Windows.Forms.Binding("Checked", this.m_CsvSettingBindingSource, "QualifyAlways", true));
      ...
      this.m_ToolTip.SetToolTip(this.m_RadioButtonAlways,
        "Writing Text the content is quoted even its is not required");
      ...
      this.m_TextBoxQuote.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.m_CsvSettingBindingSource,
        "FieldQualifier", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      ...
      this.m_TextBoxEscape.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.m_CsvSettingBindingSource,
        "EscapePrefix", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
      ...
      this.m_ToolTip.SetToolTip(this.m_TextBoxEscape,
      ...
      this.m_ToolTip.SetToolTip(this.m_TextBoxQuotePlaceHolder,
        ...
        "acter, writing data a quote will be represented by this text");
      // 
      // m_ComboBoxTrim
      // 
      this.m_ComboBoxTrim.Anchor = System.Windows.Forms.AnchorStyles.Left;
      this.m_ComboBoxTrim.DataBindings.Add(new System.Windows.Forms.Binding("SelectedValue",
        this.m_CsvSettingBindingSource, "TrimmingOption", true,
      ...
      this.m_ToolTip.SetToolTip(this.m_CheckBoxAlternateQuoting,
        "This is a uncommon way of quoting but allows to parse incorrectly quoted files, a" +
      ...
      this.m_TableLayoutPanelText.ColumnStyles.Add(
    ...
    private void timerRebuilt_Tick(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        var trimmig = TrimmingOptionEnum.All;
        if (!m_IsWriteSetting)
        {
          if (m_ComboBoxTrim.SelectedIndex != -1)
            trimmig = (TrimmingOptionEnum) m_ComboBoxTrim.SelectedValue;

          m_LabelInfoQuoting.Text = trimmig switch
          {
        ...
        if (trimmig is TrimmingOptionEnum.Unquoted or TrimmingOptionEnum.None)
        ...
        if (trimmig == TrimmingOptionEnum.None)
