  ...
  public class QuotingControl : UserControl
  {
    ...
    private void FormatPropertyChanged(object? sender, PropertyChangedEventArgs e)
    {
      if (e.PropertyName == nameof(CsvFile.FieldDelimiterChar) ||
          e.PropertyName == nameof(CsvFile.DuplicateQuotingToEscape))
        QuoteOrDelimiterChange();
    }
    ...
    private void InitializeComponent()
    {
            ...
            this.checkBoxDuplicateQuotingToEscape.DataBindings.Add(new System.Windows.Forms.Binding("Checked", this.csvSettingBindingSource, "DuplicateQuotingToEscape", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
        ...
        "ed to be defined to allow a quote to be part of the text");
            ...
            this.checkBoxAlternateQuoting.DataBindings.Add(new System.Windows.Forms.Binding("Checked", this.csvSettingBindingSource, "AlternateQuoting", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
        ...
        "s not quoted; All will remove white spaces even if the column was quoted");
            ...
            this.m_TextBoxQuotePlaceHolder.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.csvSettingBindingSource, "QuotePlaceholder", true));
    ...
    ";\"Column with ¶\r\nLinefeed\"";
            ...
            this.checkBoxQualifyAlways.DataBindings.Add(new System.Windows.Forms.Binding("Checked", this.csvSettingBindingSource, "QualifyAlways", true));
            ...
            this.checkBoxQualifyOnlyNeeded.DataBindings.Add(new System.Windows.Forms.Binding("Checked", this.csvSettingBindingSource, "QualifyOnlyIfNeeded", true));
            ...
            this.m_TextBoxEscape.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.csvSettingBindingSource, "EscapeCharacter", true));
    ...
    private void QuoteOrDelimiterChange() =>
      this.SafeInvoke(
        () =>
        {
          if (m_CsvFile is null)
            return;
          labelNoQuotes!.Visible = !(m_CsvFile!.AlternateQuoting
                                    || m_CsvFile.DuplicateQuotingToEscape
                                    || m_CsvFile.EscapeChar != '\0');
          ...
          if (string.IsNullOrEmpty(m_TextBoxQuotePlaceHolder!.Text) && !m_CsvFile!.DuplicateQuotingToEscape && string.IsNullOrEmpty(m_TextBoxEscape!.Text) && !m_CsvFile.AlternateQuoting)
          ...
          {
            if (m_CsvFile!.DuplicateQuotingToEscape)
              fastColoredTextBox.AppendText(new string(quote, 2), m_EscapedQuote);
            else
            if (m_CsvFile.AlternateQuoting || string.IsNullOrEmpty(m_TextBoxEscape!.Text))
