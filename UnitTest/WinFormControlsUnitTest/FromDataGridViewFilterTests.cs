...
namespace CsvTools.Tests
{
  ...
  public class FromDataGridViewFilterTests
  {
    ...
    public void FromDataGridViewFilter_IntData()
    {
      ...
      UnitTestStaticForms.ShowForm(() => new FromDataGridViewFilter(new ColumnFilterLogic(typeof(int), "ID"), data), 0.5, null);
    }
    ...
    public void FromDataGridViewFilter_TextData()
    {
      ...
      UnitTestStaticForms.ShowForm(() => new FromDataGridViewFilter(new ColumnFilterLogic(typeof(string), "Text"), data), .5, null);
    }
    ...
    public void FromDataGridViewFilter_DateTime()
    {
      ...
      UnitTestStaticForms.ShowForm(() => new FromDataGridViewFilter(new ColumnFilterLogic(typeof(DateTime), "DateTime"), data), .5, null);
    }
  }
}