...
namespace CsvTools.Tests
{
  ...
  public class FunctionalDITests
  {
    ...
    public void GetFileReaderTest()
    {
      ...
      using (var test2 = FunctionalDI.GetFileReader(setting, null, new CustomProcessDisplay(UnitTestInitializeCsv.Token)))
      {
    ...
    {
      var setting = new CsvFile {FileName = UnitTestInitializeCsv.GetTestPath("AlternateTextQualifiers.txt")};
      var test = FunctionalDI.GetFileWriter(setting, null, new CustomProcessDisplay(UnitTestInitializeCsv.Token));
      ...
      var test2 = FunctionalDI.GetFileWriter(setting2, null, new CustomProcessDisplay(UnitTestInitializeCsv.Token));
