...
namespace CsvTools.Tests
{
  ...
  public class JsonFileWriterTests
  {
    ...
    public void StructuredFileWriterBuildRow()
    {
      ...
      reader.Read();
      var result = writer.BuildRow(row.ToString(), reader);
      ...
      dt.Rows[0][dt.Columns["PartEmpty"].Ordinal] = "Part1|Part2|Part3|Part4";
      ...
      dt.Rows[0][dt.Columns["AllEmpty"].Ordinal] = "Lang1|Lang2";
      dt.Rows[0][dt.Columns["PartEmpty"].Ordinal] = "Part1|Part2";
