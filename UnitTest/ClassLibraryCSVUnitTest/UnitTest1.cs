...
namespace CsvTools.Tests
{
	...
	public class WorkWithStream
	{
      ...
      using (var fileStream = FileSystemUtils.OpenRead(UnitTestInitializeCsv.GetTestPath("BasicCSV.txt")))
      {
      ...
      var columnCollection = new ColumnCollection();
			...
			using (var impStream = new ImprovedStream(stream, true, SourceAccess.FileTypeEnum.FileSystem))
