...
namespace CsvTools.Tests
{
  [TestClass()]
	...
	{
		private static readonly CsvFile m_Setting = UnitTestHelper.ReaderGetAllFormats();
		...
		public async Task GetColumnIndexFromErrorColumnTest()
		{
			...
			using (var reader = new CsvFileReader(m_Setting.FullPath, m_Setting.CodePageId, m_Setting.SkipRows,
				...
				m_Setting.RecordLimit, m_Setting.AllowRowCombining, m_Setting.FileFormat.AlternateQuoting,
				m_Setting.FileFormat.CommentLine, m_Setting.NumWarnings, m_Setting.FileFormat.DuplicateQuotingToEscape,
				m_Setting.FileFormat.NewLinePlaceholder, m_Setting.FileFormat.DelimiterPlaceholder,
				m_Setting.FileFormat.QuotePlaceholder, m_Setting.SkipDuplicateHeader, m_Setting.TreatLFAsSpace,
