...
namespace CsvTools.Tests
{
  ...
  public class XmlFileTests
  {
    ...
    {
      var x1 = new XmlFile("Test1.txt") { ByteOrderMark = true, CodePageId = 100} ;
      var x2 = new XmlFile("Test1.txt") { ByteOrderMark = true, CodePageId = 100} ;
