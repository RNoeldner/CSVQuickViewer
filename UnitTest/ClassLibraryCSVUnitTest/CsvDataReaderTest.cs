...
namespace CsvTools.Tests
{
  ...
  public class CsvDataReaderUnitTest
  {
    ...
    public async Task CheckEvents()
    {
      ...
      using var test = new CsvFileReader(m_ValidSetting.FullPath, m_ValidSetting.CodePageId, m_ValidSetting.SkipRows, m_ValidSetting.HasFieldHeader, m_ValidSetting.ColumnCollection, m_ValidSetting.TrimmingOption,
        m_ValidSetting.FieldDelimiter, m_ValidSetting.FieldQualifier, m_ValidSetting.EscapeCharacter, m_ValidSetting.RecordLimit, m_ValidSetting.AllowRowCombining, m_ValidSetting.AlternateQuoting, m_ValidSetting.CommentLine,
        m_ValidSetting.NumWarnings, m_ValidSetting.DuplicateQuotingToEscape, m_ValidSetting.NewLinePlaceholder, m_ValidSetting.DelimiterPlaceholder, m_ValidSetting.QuotePlaceholder, m_ValidSetting.SkipDuplicateHeader,
        m_ValidSetting.TreatLFAsSpace, m_ValidSetting.TreatUnknownCharacterAsSpace, m_ValidSetting.TryToSolveMoreColumns, m_ValidSetting.WarnDelimiterInValue, m_ValidSetting.WarnLineFeed, m_ValidSetting.WarnNBSP,
        m_ValidSetting.WarnQuotes, m_ValidSetting.WarnUnknownCharacter, m_ValidSetting.WarnEmptyTailingColumns, m_ValidSetting.TreatNBSPAsSpace, m_ValidSetting.TreatTextAsNull, m_ValidSetting.SkipEmptyLines,
    ...
    public async Task IssueReaderAsync()
    {
      ...
      using var processDisplay = new CustomProcessDisplay(UnitTestStatic.Token);
      using var test = new CsvFileReader(basIssues.FullPath, basIssues.CodePageId, basIssues.SkipRows, basIssues.HasFieldHeader, basIssues.ColumnCollection, basIssues.TrimmingOption, basIssues.FieldDelimiter, basIssues.FieldQualifier, basIssues.EscapeCharacter, basIssues.RecordLimit, basIssues.AllowRowCombining, basIssues.AlternateQuoting, basIssues.CommentLine, basIssues.NumWarnings, basIssues.DuplicateQuotingToEscape, basIssues.NewLinePlaceholder, basIssues.DelimiterPlaceholder, basIssues.QuotePlaceholder, basIssues.SkipDuplicateHeader, basIssues.TreatLFAsSpace, basIssues.TreatUnknownCharacterAsSpace, basIssues.TryToSolveMoreColumns, basIssues.WarnDelimiterInValue, basIssues.WarnLineFeed, basIssues.WarnNBSP, basIssues.WarnQuotes, basIssues.WarnUnknownCharacter, basIssues.WarnEmptyTailingColumns, basIssues.TreatNBSPAsSpace, basIssues.TreatTextAsNull, basIssues.SkipEmptyLines, basIssues.ConsecutiveEmptyRows, basIssues.IdentifierInContainer, processDisplay);
    ...
    {
      using var processDisplay = new CustomProcessDisplay(UnitTestStatic.Token);
      using var test = new CsvFileReader(m_ValidSetting.FullPath, m_ValidSetting.CodePageId, m_ValidSetting.SkipRows, m_ValidSetting.HasFieldHeader, m_ValidSetting.ColumnCollection, m_ValidSetting.TrimmingOption, m_ValidSetting.FieldDelimiter, m_ValidSetting.FieldQualifier, m_ValidSetting.EscapeCharacter, m_ValidSetting.RecordLimit, m_ValidSetting.AllowRowCombining, m_ValidSetting.AlternateQuoting, m_ValidSetting.CommentLine, m_ValidSetting.NumWarnings, m_ValidSetting.DuplicateQuotingToEscape, m_ValidSetting.NewLinePlaceholder, m_ValidSetting.DelimiterPlaceholder, m_ValidSetting.QuotePlaceholder, m_ValidSetting.SkipDuplicateHeader, m_ValidSetting.TreatLFAsSpace, m_ValidSetting.TreatUnknownCharacterAsSpace, m_ValidSetting.TryToSolveMoreColumns, m_ValidSetting.WarnDelimiterInValue, m_ValidSetting.WarnLineFeed, m_ValidSetting.WarnNBSP, m_ValidSetting.WarnQuotes, m_ValidSetting.WarnUnknownCharacter, m_ValidSetting.WarnEmptyTailingColumns, m_ValidSetting.TreatNBSPAsSpace, m_ValidSetting.TreatTextAsNull, m_ValidSetting.SkipEmptyLines, m_ValidSetting.ConsecutiveEmptyRows, m_ValidSetting.IdentifierInContainer, processDisplay);
      await test.OpenAsync(processDisplay.CancellationToken);
    ...
    // using (var test = new CsvFileReader(m_ValidSetting.FullPath, m_ValidSetting.CodePageId,
    // m_ValidSetting.SkipRows, m_ValidSetting.HasFieldHeader, m_ValidSetting.ColumnCollection,
    // m_ValidSetting.TrimmingOption, m_ValidSetting.FieldDelimiter,
    // m_ValidSetting.FieldQualifier, m_ValidSetting.EscapeCharacter,
    // m_ValidSetting.RecordLimit, m_ValidSetting.AllowRowCombining,
    // m_ValidSetting.AlternateQuoting, m_ValidSetting.CommentLine,
    // m_ValidSetting.NumWarnings, m_ValidSetting.DuplicateQuotingToEscape,
    // m_ValidSetting.NewLinePlaceholder, m_ValidSetting.DelimiterPlaceholder,
    // m_ValidSetting.QuotePlaceholder, m_ValidSetting.SkipDuplicateHeader,
    ...
    // m_ValidSetting.WarnLineFeed, m_ValidSetting.WarnNBSP, m_ValidSetting.WarnQuotes,
    // m_ValidSetting.WarnUnknownCharacter, m_ValidSetting.WarnEmptyTailingColumns,
    // m_ValidSetting.TreatNBSPAsSpace, m_ValidSetting.TreatTextAsNull,
    // m_ValidSetting.SkipEmptyLines, m_ValidSetting.ConsecutiveEmptyRows,
    // m_ValidSetting.IdentifierInContainer, null)) { var inputValue = "17-Hello-World"; var value =
    // test.GetPart(inputValue, partToEnd); Assert.AreEqual("Hello-World", value);
    ...
    public async Task GetDateTimeTestAsync()
    {
      ...
      using var processDisplay = new CustomProcessDisplay(UnitTestStatic.Token);
      using var test = new CsvFileReader(csvFile.FullPath, csvFile.CodePageId, csvFile.SkipRows, csvFile.HasFieldHeader, csvFile.ColumnCollection, csvFile.TrimmingOption, csvFile.FieldDelimiter, csvFile.FieldQualifier, csvFile.EscapeCharacter, csvFile.RecordLimit, csvFile.AllowRowCombining, csvFile.AlternateQuoting, csvFile.CommentLine, csvFile.NumWarnings, csvFile.DuplicateQuotingToEscape, csvFile.NewLinePlaceholder, csvFile.DelimiterPlaceholder, csvFile.QuotePlaceholder, csvFile.SkipDuplicateHeader, csvFile.TreatLFAsSpace, csvFile.TreatUnknownCharacterAsSpace, csvFile.TryToSolveMoreColumns, csvFile.WarnDelimiterInValue, csvFile.WarnLineFeed, csvFile.WarnNBSP, csvFile.WarnQuotes, csvFile.WarnUnknownCharacter, csvFile.WarnEmptyTailingColumns, csvFile.TreatNBSPAsSpace, csvFile.TreatTextAsNull, csvFile.SkipEmptyLines, csvFile.ConsecutiveEmptyRows, csvFile.IdentifierInContainer, processDisplay);
      await test.OpenAsync(processDisplay.CancellationToken);
      await test.ReadAsync(processDisplay.CancellationToken);
      test.GetDateTime(1);
    }
