...
public class CsvColumnMergerTests
{
  ...
  {
    using var test = new CsvFileReader(UnitTestStatic.GetTestPath("RealignColumn.txt"), 65001, 0, 0, true, null,
                                       TrimmingOptionEnum.Unquoted, fieldDelimiterChar: '\t', fieldQualifierChar: '"',
                                       escapeCharacterChar: char.MinValue, recordLimit: 0, allowRowCombining: false,
                                       contextSensitiveQualifier: false, commentLine: "", numWarning: 0,
                                       duplicateQualifierToEscape: true, newLinePlaceholder: "",
                                       delimiterPlaceholder: "", quotePlaceholder: "", skipDuplicateHeader: true,
                                       treatLinefeedAsSpace: false, treatUnknownCharacterAsSpace: false,
                                       tryToSolveMoreColumns: true, warnDelimiterInValue: true, warnLineFeed: false,
