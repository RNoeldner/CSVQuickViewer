namespace CsvTools
{
  partial class FormEditSettings
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.quotingControl.TabIndex = 31;
      // 
      ...
      // textBoxEscapeRead
      // 
      this.textBoxEscapeRead.DataBindings.Add(new System.Windows.Forms.Binding("Character", this.bindingSourceCsvFile, "EscapePrefixChar", true));
    ...
    "";
      ...
      this.quotingControlWrite.TabIndex = 15;
      // 
      // label11
      // 
